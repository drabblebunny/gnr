...
<title>otp nsfw generator</title>

<style type="text/css">

iframe#tumblr_controls {display:none;}

body { background:#56231f; font-family:typewriter; font-size:14px; color:#ffffff; line-height:23px; }
...
#main { width:433px; margin:auto; }

#person1 { position:absolute; border:1,4px solid #ffffff; margin:216px 0px 0px 0px;  width:100px; padding:5px; background:#56231f; font-family:typewriter; font-size:14px; color:#ffffff; line-height:23px; font-style:oblique;}
#person2 { position:absolute; border:3px solid #ffffff; margin:216px 0px 0px 150px;  width:100px; padding:5px; background:#56231f; font-family:typewriter; font-size:14px; color:#ffffff; line-height:23px; font-style:oblique;}
#genbutt { position:absolute; border:1px solid #ffffff; margin:216px 0px 0px 300px;  width:100px; padding:5px 5px 5px 5px; background:#56231f; cursor:pointer; text-align:center; -webkit-user-select: none; -moz-user-select: none; -ms-user-select: none; user-select: none;  }
#genbutt:hover { margin:216px 0px 0px 301px; }

#shitbox { position:absolute; border:1px solid #ffffff; padding:10px; background:#56231f; margin:250px 0px 300px 0px; width:433px;}
#premise { }
#AU { }
...
<div id="genbutt" onclick="nsfw()">click for some nsfw</div>
...
<span id="AU"></span>
<br /><br />
<div id="thanks">(<a href="http://drabblebunny.tumblr.com">drabblebunny</a>)</span>
